...
class Evaluator(object):
    def __init__(self, args):
        ...
        val_dataset = get_segmentation_dataset(args.dataset, split='pred', mode='testval', transform=input_transform)
...
if __name__ == '__main__':
    ...
    args.save_pred = True
    if args.save_pred:
        outdir = '/root/Dataset/fcn90_pred/{}_{}_{}'.format(args.model, args.backbone, args.dataset)
